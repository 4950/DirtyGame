    ...
    public class GameLogicSystem : EntitySystem
    {
        ...
        public void decodeScenariosXML(string xmlFile)
        {
            ...
            while (scenarioReader.ReadToFollowing("scenario"))
            {
                ...
                //Health Up Modifier Value for the spawner
                float healthUpModifier;
                //Damage Up Modifier Value for the spawner
                ...
                do
                {
                    ...
                    healthUpModifier = (float)Convert.ToDouble(scenarioReader.GetAttribute("healthUpModifier"));
                    damageUpModifier = (float)Convert.ToDouble(scenarioReader.GetAttribute("damageUpModifier"));
